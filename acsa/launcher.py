...
#
# Copyright (c) 2020 YangZhe, Inc. All Rights Reserved
#
"""
ACSA launcher

Authors: YangZhe
Date:    2021/01/21 22:09:00
"""
...
from acsa.models.atae_lstm import ATAELstm
...
class ACSALauncher(Launcher):
    ...
    def _preprocess(self):
        ...
        if self._train_type == ACSALauncher.NEW_TRAIN:
            # 清理 serialize dir
...
if __name__ == '__main__':
    ...
    acsa_launcher = ACSALauncher(config_file_path=parsed_args.config, train_type=ACSALauncher.NEW_TRAIN)
    acsa_launcher()
