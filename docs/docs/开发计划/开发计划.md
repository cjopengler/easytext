...
| 序号 | 开始时间 | 结束时间 | 需求 |
|------|--------|--------|---------|
| 12 | 2020-06-26 | | conll2003 bilstm+crf|
...
## conll2003 bilstm+crf
完成基于 conll2003 的 bilstm+crf 基础模型.

具体参考 `docs.docs.ner.neural_architectures_for_named_entity_recognition.md`
